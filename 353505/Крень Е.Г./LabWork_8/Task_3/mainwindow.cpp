...
{
    ui->label_4->setText(set.contains(ui->spinBox->value()) ? "Yes" : "No");
    display();
}
...
{
    ui->label_4->setText(map.contains(ui->spinBox->value()) ? "Yes" : "No");
    display();
}
...
{
    ui->label_4->setText(QString::number(map.get(ui->spinBox->value())));
    display();
}
