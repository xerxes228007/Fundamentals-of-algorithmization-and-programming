...
BinaryHeapList::Node::Node(int d) : data(d), leftSon(nullptr), rightSon(nullptr), parent() {}
...
std::shared_ptr<BinaryHeapList::Node> BinaryHeapList::findInsertionNode() {
...
std::shared_ptr<BinaryHeapList::Node> BinaryHeapList::findLastNode() {
    std::queue<std::shared_ptr<Node>> q;
    q.push(root);
