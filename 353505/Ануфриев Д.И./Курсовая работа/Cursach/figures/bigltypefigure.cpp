...
BigLTypeFigure::BigLTypeFigure(qreal qUnit, GameField* field, QPointF pos) : FigureItem(field, pos)
{
...
QRectF BigLTypeFigure::boundingRect() const
{
    return QRectF(0, 0, 3 * qUnit, 3 * qUnit);
}

void BigLTypeFigure::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
...
TypesOfFigures::type BigLTypeFigure::getTypeOfFigure()
{
    return TypesOfFigures::type::BigLTypeFigure;
}

QPainterPath BigLTypeFigure::shape() const
{
    QPainterPath path;
