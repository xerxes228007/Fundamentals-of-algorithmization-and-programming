...
MiniLTypeFigure::MiniLTypeFigure(qreal qUnit, GameField* field, QPointF pos) : FigureItem(field, pos)
{
...
QRectF MiniLTypeFigure::boundingRect() const
{
    return QRectF(0, 0, 3 * qUnit, 3 * qUnit);
}

void MiniLTypeFigure::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
...
TypesOfFigures::type MiniLTypeFigure::getTypeOfFigure()
{
    return TypesOfFigures::type::MiniLType;
}

QPainterPath MiniLTypeFigure::shape() const
{
    QPainterPath path;
