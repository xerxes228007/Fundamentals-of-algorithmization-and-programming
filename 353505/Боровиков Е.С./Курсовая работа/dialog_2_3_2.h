#ifndef DIALOG_2_3_2_H
#define DIALOG_2_3_2_H
...
class HealthBar_1 : public QGraphicsRectItem {
public:
    HealthBar_1(int fallHeight, QGraphicsItem *parent = nullptr) : QGraphicsRectItem(parent), fallHeight(fallHeight) {
...
class FiveFloorBuilding_2 : public QGraphicsItem
{
public:
    FiveFloorBuilding_2(QGraphicsItem *parent = nullptr) : QGraphicsItem(parent) {
...
class Led_6 : public QGraphicsRectItem{
public:
    Led_6(int h){
...
class People_6 : public QGraphicsItem{
public :
    People_6(QGraphicsItem *parent = nullptr) : QGraphicsItem(parent) {}
...
class Dialog_2_3_2 : public QDialog
{
    Q_OBJECT

public:
    explicit Dialog_2_3_2(int tol, int h, QWidget *parent = nullptr);
    ~Dialog_2_3_2();
