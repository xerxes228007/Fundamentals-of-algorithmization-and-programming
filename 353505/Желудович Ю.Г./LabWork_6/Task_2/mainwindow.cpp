...
void MainWindow::runSecondPunkt()
{
    ...
    do
    {
        ...
        case 1:
        {
            ...
            QFile file("../../ЖелудовичЛаб20_0.txt");
            if (!file.open(QIODevice::WriteOnly)) {
                return;
            }
            QTextStream out(&file);
...
void MainWindow::runThirdPunkt()
{
    ...
    do
    {
        ...
        case 1:
        {
            QFile file("../../ЖелудовичЛаб20_1.txt");
...
void MainWindow::runFourthPunkt()
{
    ...
    do
    {
        ...
        case 1:
        {
            QFile file("../../ЖелудовичЛаб20_1.bin");
            if (!file.open(QIODevice::WriteOnly | QIODevice::Append)) {
                return;
            }
...
void MainWindow::runFifthPunkt()
{
    ...
    do
    {
        ...
        case 1:
        {
            ...
            QFile file("../../ЖелудовичЛаб20_3.txt");
            if (!file.open(QIODevice::WriteOnly | QIODevice::Append)) {
                return;
            }
            QTextStream out(&file);
...
{
    print("\nМеню\n\n");
    print("1. Работа с перезаписью текста (файл ЖелудовичЛаб20.txt)\n");
    print("2. Работа с массивом данных (файл ЖелудовичЛаб20_0.txt)\n");
    print("3. Работа со стурктурой Спортсмен (файл ЖелудовичЛаб20_1.txt)\n");
    print("4. Работа со стурктурой Спортсмен в бинарном файле (файл ЖелудовичЛаб20_1.bin)\n");
    print("5. Работа с дозаписью текста (файл ЖелудовичЛаб20_3.txt)\n");
