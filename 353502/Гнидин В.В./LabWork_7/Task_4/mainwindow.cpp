...
void MainWindow::buildGraphics()
{
    ...
    QGraphicsRectItem *bara1 = new QGraphicsRectItem(0, -sqrt(resOfa1)/2, 50, sqrt(resOfa1)/2);
    QGraphicsRectItem *bara2 = new QGraphicsRectItem(55, -sqrt(resOfa2)/2, 50, sqrt(resOfa2)/2);

    QGraphicsRectItem *barb1 = new QGraphicsRectItem(150, -sqrt(resOfb1)/2, 50, sqrt(resOfb1)/2);
    QGraphicsRectItem *barb2 = new QGraphicsRectItem(205, -sqrt(resOfb2)/2, 50, sqrt(resOfb2)/2);

    QGraphicsRectItem *barc1 = new QGraphicsRectItem(350, -sqrt(resOfc1)/2, 50, sqrt(resOfc1)/2);
    QGraphicsRectItem *barc2 = new QGraphicsRectItem(405, -sqrt(resOfc2)/2, 50, sqrt(resOfc2)/2);

    QGraphicsRectItem *bard1 = new QGraphicsRectItem(500, -sqrt(resOfd1)/2, 50, sqrt(resOfd1)/2);
    QGraphicsRectItem *bard2 = new QGraphicsRectItem(555, -sqrt(resOfd2)/2, 50, sqrt(resOfd2)/2);
