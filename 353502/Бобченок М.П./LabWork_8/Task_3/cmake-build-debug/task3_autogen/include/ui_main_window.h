...
public:
    ...
    void setupUi(QWidget *main_window)
    {
        ...
        get = new QPushButton(main_window);
        get->setObjectName(QString::fromUtf8("get"));
        get->setGeometry(QRect(890, 200, 88, 25));
        change = new QPushButton(main_window);
        change->setObjectName(QString::fromUtf8("change"));
        change->setGeometry(QRect(890, 420, 88, 25));
        output = new QPushButton(main_window);
        output->setObjectName(QString::fromUtf8("output"));
        output->setGeometry(QRect(890, 280, 88, 25));
    ...
    void retranslateUi(QWidget *main_window)
    {
        ...
        get->setText(QCoreApplication::translate("main_window", "Get", nullptr));
        change->setText(QCoreApplication::translate("main_window", "goToSet", nullptr));
        output->setText(QCoreApplication::translate("main_window", "output", nullptr));
    } // retranslateUi
