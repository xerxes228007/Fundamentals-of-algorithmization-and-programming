...
{
    hashTable[ui->spinBox->value()] = ui->spinBox_2->value();
    showTable();
}

void main_window::on_pushButton_2_clicked()
{
    hashTable.erase(ui->spinBox->value());
    showTable();
}
...
void main_window::showTable()
{
    ...
    QVector<QVector<int>> res = hashTable.displayHash();
        ...
        , ui(new Ui::main_window)
{
    ...
    hashTable = *new HashTable<int, int, int (*) (int)>(hash);
