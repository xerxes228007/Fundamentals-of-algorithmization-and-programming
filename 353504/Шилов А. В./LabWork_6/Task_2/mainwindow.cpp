...
void MainWindow::MainFunc()
{
    ...
    case 1:
        ...
        break;
    case 2:
        File.setFileName("/home/wiskill/LabWork_6/Task_2/Abzaz.txt");
    ...
    case 3:
        ...
        break;
    case 4:
        File.setFileName("/home/wiskill/LabWork_6/Task_2/array.txt");
        File.open(QIODevice::ReadOnly);
        s = File.readAll();
        List = s.split("}");
    ...
    case 5:
        ...
        break;
    case 6:
        File.setFileName("/home/wiskill/LabWork_6/Task_2/Struct.txt");
        File.open(QIODevice::ReadOnly);
        s = File.readAll();
        List = s.split("\n");
        for (int i = 0; i < List.size(); ++i){
    ...
    case 7:
        ...
        break;
    case 8:
        File.setFileName("/home/wiskill/LabWork_6/Task_2/Offer.txt");
        File.open(QIODevice::ReadOnly);
        s = File.readAll();
        File.close();
        ui->textEdit->setText(ui->textEdit->toPlainText() + s);
    ...
    case 9:
        ...
        break;
    case 10:
        File.setFileName("/home/wiskill/LabWork_6/Task_2/bin.txt");
        File.open(QIODevice::ReadOnly);
        in >> s;
        ui->textEdit->setText(ui->textEdit->toPlainText() + s + "\n");
        File.close();
