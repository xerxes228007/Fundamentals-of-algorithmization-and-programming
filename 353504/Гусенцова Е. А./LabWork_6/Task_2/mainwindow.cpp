...
{
    QStringList filesToCreate = {"GusentsovaLab6.txt", "GusentsovaLab6_0.txt", "GusentsovaLab6_1.txt", "GusentsovaLab6_2.bin", "GusentsovaLab6_3.txt"};
