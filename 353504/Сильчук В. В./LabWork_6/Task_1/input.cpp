...
{
    ui->setupUi(this);
    setWindowTitle("Ввод данных о животном");
...
void Input::on_bnt_send_clicked()
{
    ...
    temp.hoursOfFood[0] = ui->spb_1->value();
    temp.hoursOfFood[1] = ui->spb_2->value();
    temp.hoursOfFood[2] = ui->spb_3->value();
    temp.hoursOfFood[3] = ui->spb_4->value();
    temp.hoursOfFood[4] = ui->spb_5->value();
    temp.hoursOfFood[5] = ui->spb_6->value();
    temp.hoursOfFood[6] = ui->spb_7->value();
