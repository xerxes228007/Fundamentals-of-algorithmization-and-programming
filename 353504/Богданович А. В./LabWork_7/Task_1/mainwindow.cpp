...
void MainWindow::on_pushRandomQ1_clicked()
{
    q.clear();
...
void MainWindow::on_pushRandomQ2_clicked()
{
    q1.clear();
...
void MainWindow::on_popQ1_clicked()
{
    ...
    ui->popQ1El->setText("Удалённый элемент: "+QString::number(el));
...
void MainWindow::on_popQ2_clicked()
{
    ...
    ui->popQ2El->setText("Удалённый элемент: "+QString::number(el));
