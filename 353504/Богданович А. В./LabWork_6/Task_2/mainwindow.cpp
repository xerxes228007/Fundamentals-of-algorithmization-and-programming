...
void MainWindow::runFirstPunkt()
{
    ...
    do
    {
        ...
        case 1:
        {
            ...
            QFile file("../../БогдановичЛаб20.txt");
...
void MainWindow::runSecondPunkt()
{
    ...
    do
    {
        ...
        case 1:
        {
            ...
            QFile file("../../БогдановичЛаб20_0.txt");
            if (!file.open(QIODevice::WriteOnly)) {
                return;
            }
            QTextStream out(&file);
...
void MainWindow::runThirdPunkt()
{
    ...
    do
    {
        ...
        case 1:
        {
            QFile file("../../БогдановичЛаб20_1.txt");
            if (!file.open(QIODevice::WriteOnly | QIODevice::Append)) {
                return;
            }
            QTextStream out(&file);

            int age = 18, goldMedals = 0, silverMedals = 0, bronzeMedals = 0;
            double height = 1.5;
            QString gender = "m", isActive = "y", name = "name";
            ...
            print("Введите рост спортсмена: \n");
            do
            {
                if(height <= 0 || height > 200) print("Ввод некорректный! Повторите ввод: \n");
                height = inputDouble();
            ...
            do
            {
                if(gender != "f" && gender != "m") print("Ввод некорректный! Повторите ввод: \n");
                gender = input();
            } while(gender != "f" && gender != "m");

            print("Введите занимается ли спортсмен спортом сейчас (y/n): \n");
            do
            {
                if(isActive != "y" && isActive != "n") print("Ввод некорректный! Повторите ввод: \n");
                isActive = input();
            } while(isActive != "y" && isActive != "n");
            ...
            out << age << ' ' << height << ' ' << gender << ' ' << (isActive == "y" ? "true" : "false") << ' '
        ...
        case 2:
        {
            ...
            while(!in.atEnd())
            {
                in >> age >> height >> gender >> isActive >> name >> goldMedals >> silverMedals >> bronzeMedals;

                if(gender != "" && isActive != "")
                {
                    print(QString::number(age) + '|' + QString::number(height) + '|' + gender + '|' + isActive
...
void MainWindow::runFourthPunkt()
{
    ...
    do
    {
        ...
        case 1:
        {
            QFile file("../../БогдановичЛаб20_1.bin");
            if (!file.open(QIODevice::WriteOnly | QIODevice::Append)) {
                return;
            }
            ...
            Sportsman sportsman;
            sportsman.age = age;
            sportsman.height = height;
            sportsman.gender = gender.toStdString()[0];
            sportsman.isActive = ((isActive == "true") ? true : false);
        ...
        case 2:
        {
            ...
            while (file.read(reinterpret_cast<char*>(&sportsman), sizeof(Sportsman))) {
                ...
                isActive = (sportsman.isActive ? "true" : "false");
                name = sportsman.name;
...
void MainWindow::runFifthPunkt()
{
    ...
    do
    {
        ...
        case 1:
        {
            ...
            QFile file("../../БогдановичЛаб20_3.txt");
            if (!file.open(QIODevice::WriteOnly | QIODevice::Append)) {
                return;
            }
            QTextStream out(&file);
...
{
    print("\nМеню\n\n");
    print("1. Работа с перезаписью текста\n");
    print("2. Работа с массивом данных\n");
    print("3. Работа со стурктурой Спортсмен\n");
    print("4. Работа со стурктурой Спортсмен в бинарном файле\n");
    print("5. Работа с дозаписью текста\n");
