...
MainWindow::MainWindow(QWidget *parent)
    ...
    , _keyboard(new MyKeyboard(this))
    , _analizer(new InputAnalize("", _keyboard, Bel, this))
{
    ui->setupUi(this);
    ...
    qDebug() << "Mei gui shi hong se de Zi luo lan shi lan se de Tang shi tian de Ni ye shi.";
}
...
{
    _presets.at(0) = "sifjsldk kldjfskl sdkfjlsk";
    _presets.at(1) = "lkfjg azéfjv smldfk xmclvk ljf";
