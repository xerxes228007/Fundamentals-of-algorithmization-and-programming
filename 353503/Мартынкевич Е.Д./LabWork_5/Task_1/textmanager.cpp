...
void TextManager::SetDictionary(int locale)
{
    ...
    {
    case 0:
        file.setFileName(":/arabic");
        break;
    case 1:
        file.setFileName(":/belarusian");
        break;
    case 2:
        file.setFileName(":/chinese");
        break;
    case 3:
        file.setFileName(":/english");
        break;
    case 4:
        file.setFileName(":/french");
        break;
    case 5:
        file.setFileName(":/german");
        break;
    case 6:
        file.setFileName(":/hebrew");
        break;
    }
    if (!file.open(QIODevice::ReadOnly | QIODevice::Text))
    {
