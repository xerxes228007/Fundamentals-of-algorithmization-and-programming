...
class Empty(Error):
    def __repr__(self): return 'Error::Empty'


class Incomplete(Error):
    def __repr__(self): return 'Error::Incomplete'
...
class Syntax(Error):
    ...
    def __repr__(self): return 'Error::Syntax'

    def __str__(self): return f'Syntax error: expected {self.expected}, got {self.got}'
