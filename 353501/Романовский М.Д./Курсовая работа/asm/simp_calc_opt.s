...
READ_OP: @STACKOPT {
  ...
  $CALL READ_STRING ($PLABEL READ_OP_BUF; $PCONST 1)
  $DROP

  $LOAD ($PLABEL READ_OP_BUF) # Load char from buf onto stack
...
READ_NUM_16: @STACKOPT {
  ...
  $CALL READ_STRING ($PLABEL READ_NUM_16_BUF; $PCONST 5) 
  ...
  $SVAR 1 ($PLABEL READ_NUM_16_BUF)
  $SARG 0 ($PUZX)

  READ_LOOP:

  $CALL MATCH_CHAR_TO_NUM ($LOAD ($LVAR 1); $PUZX)
  $JEQ FAIL_READ
...
READ_NUM_16_BUF: 0 0 0 0 0 0 0
INVALID_NUMBER: "Invalid number\n" 0

# =============================================

EXECUTE_OPERATION: @STACKOPT {
  #     2  1 0
  # ARG op a b
  # RET te
  $FUNC 0 3 1
...
PRINT_NUM16: @STACKOPT {
  ...
  $SVAR 0 ($DEC ($PLABEL NUM_16_PRINT_BUF_END))
...
NUM_16_PRINT_BUF: "######" NUM_16_PRINT_BUF_END: 0xa 0 0
