...
void MainWindow::fillTreeWidgetFromBST(QTreeWidgetItem *item, BinaryTree<QString>::Data *node)
{
    if (node == nullptr)
        return;
...
void MainWindow::on_insertSubtreeButton_clicked()
{
    ...
    tree.insertSubtree(BinaryTree<QString>(a).root, ui->infoLineEdit->text());
    displayTree();
}
