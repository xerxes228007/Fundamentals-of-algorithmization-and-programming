...
{
    QString directoryPath = QFileDialog::getExistingDirectory(nullptr, QObject::tr("Выберите папку"), "/home/kirill", QFileDialog::ShowDirsOnly | QFileDialog::DontResolveSymlinks);
