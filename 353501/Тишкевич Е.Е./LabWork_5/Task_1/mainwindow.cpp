...
void MainWindow::initDictionaryes(){
    ...
    dictionary.resize(7);
    {
        QFile file("/egortishkevic/dic/deu.txt");
    ...
    {
        QFile file("//egortishkevic/dic/fra.txt");
        if (!file.open(QIODevice::ReadOnly | QIODevice::Text)) {
    ...
    {
        QFile file("/egortishkevic/dic/ara.txt");
        if (!file.open(QIODevice::ReadOnly | QIODevice::Text)) {
            qDebug() << "Ошибка открытия файла";
            return;
        }
    ...
    {
        QFile file("//egortishkevic/dic/eng.txt");
        if (!file.open(QIODevice::ReadOnly | QIODevice::Text)) {
            qDebug() << "Ошибка открытия файла";
            return;
        }
    ...
    {
        QFile file("/egortishkevic/dic/bel.txt");
        if (!file.open(QIODevice::ReadOnly | QIODevice::Text)) {
            qDebug() << "Ошибка открытия файла";
            return;
        }
    ...
    {
        QFile file("/egortishkevic/dic/her.txt");
        if (!file.open(QIODevice::ReadOnly | QIODevice::Text)) {
            qDebug() << "Ошибка открытия файла";
            return;
        }
    ...
    {
        QFile file("/egortishkevic/dic/chn.txt");
        if (!file.open(QIODevice::ReadOnly | QIODevice::Text)) {
            qDebug() << "Ошибка открытия файла";
            return;
        }
