...
Train::Train(QWidget *parent) : QLineEdit(parent)
{

}

void Train::keyPressEvent(QKeyEvent *event)
{
...
void Train::keyReleaseEvent(QKeyEvent *event)
{
...
void Train::inputMethodEvent(QInputMethodEvent *event)
{
