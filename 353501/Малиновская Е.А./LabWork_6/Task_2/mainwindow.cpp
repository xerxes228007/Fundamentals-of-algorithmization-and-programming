...
void MainWindow::start()
{
...

    {
        ...
        timer.stop();
        ui->label->setText(QString("1 - Ввод данных для сохранения в файле МалиновскаяЛаб20.txt \n")+QString("2 - Чтение данных из файла МалиновскаяЛаб20.txt \n")+QString("3 - Ввод массива ushort  с разделяющим элементом *"
                                                                                                                                                                 " в текстовый файл МалиновскаяЛаб20_0.txt \n")+QString("4 - Чтение из файла МалиновскаяЛаб20_0.txt \n")+QString("5 - Ввод данных для заполнения структуры самолет и  сохранения в файле МалиновскаяЛаб20_1.txt \n")
                           +QString("6 - Чтение структур из файла МалиновскаяЛаб20_1.txt \n")+ QString("7 - Ввод данных для заполнения структуры самолет и  сохранения в файле МалиновскаяЛаб20_2.bin \n")+QString("8 - Чтение структур из файла МалиновскаяЛаб20_2.bin \n")
                           +  QString("9 - Запись в файл МалиновскаяЛаб20_3.txt \n")+QString("10 - Чтение из файла МалиновскаяЛаб20_3.txt \n")+QString("0 - Выход \n"));
        ui->label->update();
        bool ok=0;
        ...
        case 1:
        {
            ...
            QString path="/home/ljlinux/Documents/images/МалиновскаяЛаб20.txt";
            QFile file(path);
            QTextStream in(&file);
        ...
        case 3:
        {
            ...
            while(fl1){
                ...
                QString path="/home/ljlinux/Documents/images/МалиновскаяЛаб20_0.txt";
                QFile file(path);
                QTextStream in(&file);
                QString s;
                file.open(QIODevice::WriteOnly | QIODevice::Text);
        ...
        case 5:
        {
            ...
            QString path="/home/ljlinux/Documents/images/МалиновскаяЛаб20_1.txt";
            QFile file(path);
            QTextStream in(&file);
            QString s;
        ...
        case 7:
        {
            ...
            QString path="/home/ljlinux/Documents/images/МалиновскаяЛаб20_2.bin";
            QFile file(path);
            QTextStream in(&file);
            QString s;
            file.open(QIODevice::Append | QIODevice::Text);
        ...
        case 9:
        {
            QString path="/home/ljlinux/Documents/images/МалиновскаяЛаб20_3.txt";
            QFile file(path);
            QTextStream in(&file);
            file.open(QIODevice::Append | QIODevice::Text);
            QString text;
