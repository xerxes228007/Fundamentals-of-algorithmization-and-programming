...
MainWindow::MainWindow(QWidget * parent): QMainWindow(parent),
  ui(new Ui::MainWindow) {
    ...
    connect(timer, &QTimer::timeout, this, &MainWindow::gggg);
    timer->start(500);
  }
...
void MainWindow::on_openfile_clicked() {
  fileName = QFileDialog::getOpenFileName(this, tr("Открытие"), "//", tr("Текстовые документы (*.txt)"));
...
bool MainWindow::CheckFile(QString date) {
  ...
  if (month > 12 || day > 31 || month < 0 || day < 0 || year < 0 || year > 9999) {
    return false;
  }
