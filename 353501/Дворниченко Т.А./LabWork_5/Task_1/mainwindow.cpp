...
ui->ln_training->setText(oldStr.mid(0, index * 28) + "<font color=" + "\"" + color + "\""  + ">" + oldStr.mid(index * 28 + 20, 1) + "</font>" +
                             oldStr.mid(index * 28 + 21));
}
...
void MainWindow::setupPopularWords()
{
    QStringList folderPaths = {
                               ...
                               ":/dictionary/arabianWords.txt",
                               ":/dictionary/englishWords.txt",
                               ":/dictionary/belarusianWords.txt",
                               ":/dictionary/herbewWords.txt",
                               ":/dictionary/chinesesWords.txt"};
