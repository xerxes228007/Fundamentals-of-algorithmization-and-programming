    ...
    , ui(new Ui::MainWindow)
{
    ...
    words.resize(7);
    {
        QFile file("/home/evgeniy/Рабочий стол/Lalka5/taskFirstPre/asef/Words/eng.txt");
    ...
    {
        QFile file("/home/evgeniy/Рабочий стол/Lalka5/taskFirstPre/asef/Words/ger.txt");
        file.open(QIODevice::ReadOnly | QIODevice::Text);
        QTextStream in(&file);
        while (!in.atEnd()) {
            line = in.readLine();
    ...
    {
        QFile file("/home/evgeniy/Рабочий стол/Lalka5/taskFirstPre/asef/Words/fra.txt");
        file.open(QIODevice::ReadOnly | QIODevice::Text);
        QTextStream in(&file);
        while (!in.atEnd()) {
            line = in.readLine();
    ...
    {
        QFile file("/home/evgeniy/Рабочий стол/Lalka5/taskFirstPre/asef/Words/her.txt");
        file.open(QIODevice::ReadOnly | QIODevice::Text);
        QTextStream in(&file);
        while (!in.atEnd()) {
            line = in.readLine();
    ...
    {
        QFile file("/home/evgeniy/Рабочий стол/Lalka5/taskFirstPre/asef/Words/ara.txt");
        file.open(QIODevice::ReadOnly | QIODevice::Text);
        QTextStream in(&file);
        while (!in.atEnd()) {
            line = in.readLine();
    ...
    {
        QFile file("/home/evgeniy/Рабочий стол/Lalka5/taskFirstPre/asef/Words/chn.txt");
        file.open(QIODevice::ReadOnly | QIODevice::Text);
        QTextStream in(&file);
        while (!in.atEnd()) {
            line = in.readLine();
    ...
    {
        QFile file("/home/evgeniy/Рабочий стол/Lalka5/taskFirstPre/asef/Words/bel.txt");
        file.open(QIODevice::ReadOnly | QIODevice::Text);
        QTextStream in(&file);
        while (!in.atEnd()) {
            line = in.readLine();
