...
void MainWindow::on_bnt_memcpy_clicked()
{
    ...
    trusi->memcpy(str1, byteArray1.constData(), n + 1);
    str1[n] = '\0';
...
void MainWindow::on_bnt_memmove_clicked()
{
    ...
    trusi->memmove(str1, byteArray1.constData(), byteArray1.size());
...
void MainWindow::on_bnt_strcpy_clicked()
{
    ...
    trusi->memcpy(src, byteArray.constData(), byteArray.size());
    src[byteArray.size()] = '\0';
    char dest[100];
    trusi->strcpy(dest, src);
...
void MainWindow::on_bnt_strcat_clicked()
{
    ...
    trusi->memcpy(str, byteArray1.constData(), byteArray1.size());
    str[byteArray1.size()] = '\0';
    trusi->strcat(str, byteArray2.constData());
...
void MainWindow::on_bnt_memset_clicked()
{
    ...
    trusi->memcpy(str, byteArray.constData(), byteArray.size());
    trusi->memset(str + byteArray.size(), value, n);
...
void MainWindow::on_bnt_strcoll_clicked()
{
    QByteArray byteArray1 = ui->ln_str1->text().toUtf8();
    QByteArray byteArray2 = ui->ln_str2->text().toUtf8();
    int result = trusi->strcoll(byteArray1.constData(), byteArray2.constData());
    QString message;
    if (result == 0) {
...
void MainWindow::on_bnt_strxfrm_clicked()
{
    ...
    size_t result = trusi->strxfrm(dest, byteArray.constData(), n);
    if (result < n) {
        ui->ln_ans->setText(dest);
    } else {
...
{
    QByteArray byteArray = ui->ln_str1->text().toUtf8();
    size_t length = trusi->strlen(byteArray.constData());
...
void MainWindow::on_bnt_strcmp_clicked()
{
    QByteArray byteArray1 = ui->ln_str1->text().toUtf8();
    QByteArray byteArray2 = ui->ln_str2->text().toUtf8();
    int result = trusi->strcmp(byteArray1.constData(), byteArray2.constData());
    QString message;
    if (result == 0) {
        message = "Строки равны";
    } else if (result < 0) {
...
void MainWindow::on_bnt_strncmp_clicked()
{
    ...
    QByteArray byteArray2 = ui->ln_str2->text().toUtf8();
    size_t n = ui->spb_N->value();
    int result = trusi->strncmp(byteArray1.constData(), byteArray2.constData(), n);
    QString message;
    if (result == 0) {
...
void MainWindow::on_bnt_memcmp_clicked()
{
    ...
    QByteArray byteArray2 = ui->ln_str2->text().toUtf8();
    size_t n = ui->spb_N->value();
    int result = trusi->memcmp(byteArray1.constData(), byteArray2.constData(), n);
    QString message;
    if (result == 0) {
...
void MainWindow::on_bnt_strncat_clicked()
{
    ...
    trusi->strncpy(str, byteArray1.constData(), byteArray1.size());
    trusi->strncat(str, byteArray2.constData(), n);
